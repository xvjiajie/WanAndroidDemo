...
public class Resource<T> {
    ...
    public Resource(int state, T data) {
        this.state = state;
        this.data = data;
    }
    ...
    public Resource(int state, int code, String errorMsg) {
        this.state = state;
        this.errorMsg = errorMsg;
        this.code = code;
    }
     ...
     * @return
     */
    public static <T> Resource<T> failure(int code, String msg) {
        return new Resource<>(FAIL, code, msg);
    }
